...
import { fadeUp, slideLeft, slideRight, staggerContainer, lineReveal, badgePop } from "@/lib/animations";
          ...
          >
            ...
            <motion.div variants={slideLeft} custom={0} className="space-y-6">
              {[
                {
                  ...
                  content: (
                    <a href="mailto:ieee@nirmauni.ac.in" className="font-body text-muted-foreground hover:text-primary transition-colors fancy-link">
                      ieee@nirmauni.ac.in
                    </a>
                  ),
                },
                ...
                <motion.div
                  ...
                  whileHover={{ y: -4, boxShadow: "var(--shadow-brutal-hover)", transition: { type: "spring", stiffness: 200 } }}
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-heading font-extrabold text-lg mb-1">{item.title}</h3>
                      {item.content}
                    </div>
                  </div>
                </motion.div>
              ...
              >
                ...
                <motion.div className="flex gap-3" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <motion.div variants={slideRight} custom={0}>
              <motion.form
                ...
                whileHover={{ boxShadow: "var(--shadow-brutal-hover)", transition: { duration: 0.2 } }}
              >
                <h2 className="text-2xl font-heading font-extrabold mb-2">Send a Message</h2>
                <motion.div className="line-accent w-12 mb-4" initial={{ scaleX: 0 }} whileInView={{ scaleX: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }} />
                ...
                {[
                  ...
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <label className="font-heading font-bold text-sm uppercase tracking-wide block mb-2">{field.label}</label>
                    <input
                      type={field.type}
                      required
